...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="<?= base_url() ?>/assets/images/dalwa/dalwa.ico">
    ...
    <style type="text/css">
        *{
        ...
        #parent {
            ...
            height: 100vh;
            display: table;
            background-image: url("<?= base_url() ?>/assets/images/dalwa/bg_blue.jpg");
...
<body>
    <div id="parent">
        <div id="child">
            ...
            <div class="wrapper">
                <a href="javascript:history.go(-1)"><button class="btn-l">Back</button></a>
                <a href="<?= base_url(); ?>"><button class="btn-l">Home</button></a>
            </div>
            <div class="wrapper footer" style="white">
                <small>Dalwa IT © <?=date('Y')?></small>
            </div>
        </div>
    </div>
